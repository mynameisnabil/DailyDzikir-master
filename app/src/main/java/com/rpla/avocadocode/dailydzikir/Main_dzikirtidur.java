...
public class Main_dzikirtidur extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dzikirtidur);


        final String[] arabtidArray = {"بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ  قُلْ هُوَ اللَّهُ أَحَدٌ اللَّهُ الصَّمَدُ لَمْ يَلِدْ وَلَمْ يُولَدْ وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ",
        ...
        ListView listView;
        CustomListAdapterDt whatever = new CustomListAdapterDt(this, arabtidArray, dibacatidArray, artitidArray);
        listView = (ListView) findViewById(R.id.ListViewIDtid);
        listView.setAdapter(whatever);

    }

    public void btn_hometidur(View view) {
        Intent i = new Intent(Main_dzikirtidur.this, MainActivity.class);
        startActivity(i);
