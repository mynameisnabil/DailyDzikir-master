...
public class Main_dzikirpagi extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dzikirpagi);


        final String[] arabArray = {"أَعُوذُ بِاللَّهِ مِنَ الشَّيْطَانِ الرَّجِيم",
        ...
        ListView listView;
        CustomListAdapterDp whatever = new CustomListAdapterDp(this, arabArray, dibacaArray, artiArray);
        listView = (ListView) findViewById(R.id.ListViewID);
        listView.setAdapter(whatever);

    }

    public void btn_homepagi(View view) {
        Intent i = new Intent(Main_dzikirpagi.this, MainActivity.class);
        startActivity(i);
